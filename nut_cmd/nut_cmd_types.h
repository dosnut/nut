...
namespace nut_cmd {
	...
	typedef enum {CMD_HELP,CMD_LIST_DEVICES,CMD_DEVICE,CMD_LIST_ENVIRONMENTS,CMD_ENABLE,CMD_DISABLE,CMD_TYPE,CMD_ACTIVE_ENVIRONMENT,CMD_SET_ENVIRONMENT,CMD_ENVIRONMENT,CMD_STATE,CMD_UNKNOWN} NUT_COMMANDS;
	struct NutCommand {
