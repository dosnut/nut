	...
	*/
	class CNetworkConfig { //All without linebreak
		...
		public:
			...
			bool set_wep_key1(QString key, bool addQuotes = false);
			bool set_wep_key2(QString key, bool addQuotes = false);
			bool set_wep_key3(QString key, bool addQuotes = false);
			bool set_wep_tx_keyidx(int idx);
			bool set_peerkey(bool enabled);
			bool set_eap(QString str);
			bool set_identity(QString str, bool addQuotes = false);
			bool set_anonymous_identity(QString str, bool addQuotes = false);
			bool set_password(QString str, bool addQuotes = false);
			bool set_ca_cert(QString str, bool addQuotes = false);
			bool set_ca_path(QString str, bool addQuotes = false);
			bool set_client_cert(QString str, bool addQuotes = false);
			bool set_private_key(QString str, bool addQuotes = false);
			bool set_private_key_passwd(QString str, bool addQuotes = false);
			bool set_dh_file(QString str, bool addQuotes = false); 
			bool set_subject_match(QString str, bool addQuotes = false); 
			bool set_altsubject_match(QString str, bool addQuotes = false); 
			bool set_phase1(QString str, bool addQuotes = false); 
			bool set_phase2(QString str, bool addQuotes = false); 
			bool set_ca_cert2(QString str, bool addQuotes = false); 
			bool set_ca_path2(QString str, bool addQuotes = false); 
			bool set_client_cert2(QString str, bool addQuotes = false); 
			bool set_private_key2(QString str, bool addQuotes = false); 
			bool set_private_key2_passwd(QString str, bool addQuotes = false);
			bool set_dh_file2(QString str, bool addQuotes = false); 
			bool set_subject_match2(QString str, bool addQuotes = false); 
			bool set_altsubject_match2(QString str, bool addQuotes = false); 
			bool set_fragment_size(int size);
			bool set_eappsk(QString str); 
			bool set_nai(QString str, bool addQuotes = false); 
			bool set_pac_file(QString str, bool addQuotes = false); 
	};
